...
\documentclass[ing,male,java,dept460,twoside]{diploma}						% jednostranny dokument
...
\CzechKeywords{VoiceXML, VXML, hlasový portál, JSON, automatické rozpoznávání řeči, syntéza řeči, JavaScript, Node.js, AngularJS, Asterisk, VoiceGlue, Voxeo Prophecy, SIP, ASR, TTS}
...
\EnglishKeywords{VoiceXML, VXML, voice portal, JSON, automatic speech recognition, speech synthesis, JavaScript, Node.js, AngularJS, Asterisk, VoiceGlue, Voxeo Prophecy, SIP, ASR, TTS}
...
\InsertFigure{Figures/vxml_document_structure}{0.9\textwidth}{Stromová struktura dokumentu VoiceXML}{fig:vxml_document_structure}
...
\InsertSidewaysFigure{Figures/web_flight_list}{1\textwidth}{Stránka se seznamem letů a filtrem}{fig:FlightList}
...
\InsertSidewaysFigure{Figures/web_flight_detail}{1\textwidth}{Stránka s formulářem pro editaci letu}{fig:FlightDetail}
...
\InsertSidewaysFigure{Figures/diagrams/mainflow}{1\textwidth}{Hlavní struktura hlasového portálu}{fig:MainFlow}
...
\InsertFigure{Figures/diagrams/getlogindataflow}{0.8\textwidth}{Struktura stavu $getLoginData$ $(GetLoginDataFlow)$}{fig:GetLoginDataFlow}
...
\lstinputlisting[language=JavaScript,label=src:Audio_example,caption={Vytvoření instance třídy \texttt{Audio}}]{Src/Audio_example.js}
...
\lstinputlisting[language=JavaScript,label=src:Silence_example,caption={Vytvoření instance třídy \texttt{Silence}}]{Src/Silence_example.js}
...
\lstinputlisting[language=JavaScript,label=src:SayAs_example,caption={Vytvoření instance třídy \texttt{SayAs}}]{Src/SayAs_example.js}
...
\lstinputlisting[language=JavaScript,label=src:Var_function,caption={Použití zástupného objektu \texttt{Var} s funkčním parametrem}]{Src/Var_function.js}
...
\InsertSidewaysFigure{Figures/diagrams/destinationselectionflow}{0.9\textwidth}{Struktura stavu $destinationSelection$ $(DestinationSelectionFlow)$}{fig:DestinationSelectionFlow}
...
\bibitem{vxml_rychlokurz} Pavel Bezpalec; Katedra telekomunikační techniky, ČVUT Praha,
...
\bibitem{festvox_org} Alan W. Black,
...
\bibitem{cepstral_com} Cepstral LLC,
...
\bibitem{nuance_com} Nuance Communications, Inc.,
\textit{Web společnosti Nuance}, http://www.nuance.com, 2014.

\bibitem{angulardocs} Google, Inc.,
