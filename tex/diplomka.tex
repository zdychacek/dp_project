...
Z analýzy vytíženosti procesů $asterisk$, $voiceglue$ a $phoneglue$ vyvodíme paměťovou a výpočetní náročnost běhového prostředí hlasové platformy.

Z vytíženosti procesů $node$ a $mongod$ zjistíme výpočetní a paměťovou náročnost aplikačního serveru, konkrétně tedy webového a databázového serveru.
...
\InsertSidewaysFigure{Figures/benchmark_charts/cpu_60_60}{1\textwidth}{Registrace nové VXML aplikace}{fig:Voxeo_admin}
