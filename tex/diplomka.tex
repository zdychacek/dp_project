...
IVR Voxeo Prophecy je možné provozovat na operačních systémech Windows (32 i 64 bitů), OS X a na linuxových distribucích, které jsou založeny na RHEL (např. CentOS). Pro produkční prostředí je však doporučován operační systém založený na linuxu.
