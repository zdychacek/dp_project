...
V následující části se budu podrobně věnovat jednotlivým částem rozhraní API, které nám knihovna nabízí.

\subsubsection{Aplikační rozhraní vyvíjené knihovny}
Popis struktury knihovny. Srovnání návrhu aplikace pomocí knihovny a klasického přístupu. Příklad zpracování vstupu a výstupu. Knihovna vs. VXML markup.
