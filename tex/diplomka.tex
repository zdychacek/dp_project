...
V URL adrese požadavku může být obsažen ještě jeden parametr. Jedná se o parametr \InlCode{result}. Pokud právě dochází ke zpracování stavu, který zajišťoval vstup od uživatele, pak je hodnotou tohoto parametru právě získaný vstup.
...
Jedná o abstraktní třídu, ze které se instance nevytvářejí přímo. Slouží jako bázová třída, ze které jsou odvozeny třídy reprezentující konkrétní hlasový model.
