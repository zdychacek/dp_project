...
Třída \InlCode{Say} interně obsahuje instanci třídy \InlCode{Prompt} a nastavuje hodnoty některým zděděným vlastnostem.

Ukázku vytvoření stavu, který obsahuje hlasový model tohoto typu je možné vidět ve výpise \hyperref[src:MenuExample]{zdrojového kódu} ukázkové aplikace na řádku číslo 11.
