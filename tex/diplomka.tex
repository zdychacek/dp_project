...
\label{sec:Exit}
Třída \InlCode{Exit} implementuje hlasový model, který uživateli předloží zprávu a poté ukončí provádění aplikace a dojde tak k zavěšení hovoru.
...
Jelikož práce s tímto hlasovým modelem není demonstrována ve zdrojovým kódu ukázkové aplikace, tak ve výpise č. \ref{src:Record_example} uvádím ukázku zdrojového kódu, který vytváří stav, jehož hlasovým modelem je instance této třídy. Z ukázky je dále vidět způsob, jakým je možné nahrávku uložit na disk.
