...
\lstdefinelanguage{JavaScript}{
	keywords=[1]{break, case, catch, continue, debugger, default, delete, do, else, finally, for, function, function*, if, in, instanceof, new, return, switch, this, throw, try, typeof, var, void, while, with},
...
\lstinputlisting[label=src:Prompt_Constructor,caption={Ukázka vytvoření instance třídy \InlCode{Prompt}}]{Src/Prompt_Constructor.js}
...
\lstinputlisting[label=src:Say_Constructor,caption={Ukázka vytvoření instance třídy \InlCode{Say}}]{Src/Say_Constructor.js}
...
\lstinputlisting[label=src:Say_Vxml,caption={VXML kód vygenerovaný pro stav s hlasovým modelem \InlCode{Say}}]{Vxml/Say.vxml}
...
\lstinputlisting[label=src:Exit_Vxml,caption={VXML kód vygenerovaný pro stav s hlasovým modelem \InlCode{Exit}}]{Vxml/Exit.vxml}
...
\lstinputlisting[label=src:Record_example,caption={Vytvoření stavu s hlasovým modelem \InlCode{Record}}]{Src/Record_example.js}

Ve výpise \ref{src:Record_Vxml} je pro představu uveden VXML kód, který aplikace pro takový stav automaticky vygeneruje.

\lstinputlisting[label=src:Record_Vxml,caption={VXML kód vygenerovaný pro stav s hlasovým modelem \InlCode{Record}}]{Vxml/Record.vxml}
...
\lstinputlisting[label=src:Ask_Vxml,caption={VXML kód vygenerovaný pro stav s hlasovým modelem \InlCode{Ask}}]{Vxml/Ask.vxml}
...
\lstinputlisting[label=src:Grammar_example,caption={Vytvoření hlasové gramatiky}]{Src/Grammar_example.js}
...
\lstinputlisting[label=src:Choices_example,caption={Vytvoření kombinované gramatiky \InlCode{Choices}}]{Src/Choices_example.js}
...
\lstinputlisting[label=src:Audio_example,caption={Vytvoření instance \InlCode{Audio}}]{Src/Audio_example.js}
...
\lstinputlisting[label=src:Silence_example,caption={Vytvoření instance \InlCode{Silence}}]{Src/Silence_example.js}
...
\lstinputlisting[label=src:SayAs_example,caption={Vytvoření instance \InlCode{SayAs}}]{Src/SayAs_example.js}
...
\lstinputlisting[label=src:Var_example,caption={Demonstrace využití zástupného objektu \InlCode{Var}}]{Src/Var_example.js}
...
\lstinputlisting[label=src:Var_function,caption={Demonstrace využití zástupného objektu \InlCode{Var}}]{Src/Var_function.js}
