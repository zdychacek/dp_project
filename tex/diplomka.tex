...
\InsertFigure{Figures/diagrams/bench_scenario}{1\textwidth}{Diagram testovacího scénáře}{fig:Bench_scenario}

\subsection{Použité nástroje}
Pro provedení zátěžových testů bylo potřeba zvolit vhodný nástroj, který nám umožní nasimulovat klienty, kteří se připojují k hlasovému portálu a nástroj, který nám umožní měřit vytížení systému a konkrétních procesů.
...
Po spuštění skript provede následující operace:
