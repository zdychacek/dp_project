...
Analýza vytíženosti procesů $asterisk$, $voiceglue$ a $phoneglue$ nám ukáže paměťovou a výpočetní náročnost běhového prostředí hlasové platformy a z vytíženosti procesů $node$ a $mongod$ zjistíme výpočetní a paměťovou náročnost aplikačního serveru, konkrétně tedy webového a databázového serveru.
