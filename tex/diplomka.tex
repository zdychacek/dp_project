...
Komponenta implementuje veřejnou metodu \InlCode{getDate}. Tato metoda vrací prostřednictvím návratové hodnoty zadané datum. Metoda je typicky volána v rámci akce \InlCode{onExitAction} definované na stavu, jehož je komponenta součástí.
...
Třída \InlCode{GetTextInputDtmfFlow} implementující tuto komponentu vystavuje veřejnou metodu \InlCode{getInput}. Metoda vrací zadaný vstup převedený do textové podoby.
...
Struktura této komponenty je znázorněna v diagrumu \ref{fig:GetDestinationFlow}. Komponenta je implementována třídou \InlCode{GetDestinationFlow}.
...
V momentě, kdy uživatel zadaný vstup potvrdí stiskem klávesy 1, přechází provádění do stavu $destinationSelection$. Tento stav obsahuje komponentu \InlCode{DestinationSelectionFlow}, která tvoří vnitřní stavy tohoto stavu.
...
Komponenta implementuje metodu \InlCode{getSelectedDestination}, která slouží k získání zvolené destinace. Tato metoda je typicky volána v rámci akce \InlCode{onExitAction} definované na stavu, jehož je komponenta součástí.
